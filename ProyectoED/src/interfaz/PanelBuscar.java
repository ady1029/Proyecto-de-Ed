...
public class PanelBuscar extends JDialog {
	...
	public PanelBuscar(MenuPrincAdmin father, RedSystem sistema, MenuUsuario a) {
		menup = father;
		red = sistema;
		menuU = a;
		...
		btnmcnAtrs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(a == null) {
					MenuPrincAdmin frame = new MenuPrincAdmin(red, null);
				...
				if(father == null) {
					MenuUsuario frame = new MenuUsuario(null, red, null);
					frame.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
					frame.setVisible(true);
					setVisible(false);
					dispose();
