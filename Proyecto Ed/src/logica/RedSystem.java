...
public class RedSystem implements Serializable{
	...
	public void almacenarEnFicheroIslas(LinkedList<Person>islas) throws IOException {
		RandomAccessFile islasFile = new RandomAccessFile("islas.text", "rwd");
	...
	public void almacenarEnFicheroComunidades(LinkedList<Comunity>comunidades) throws IOException {
		RandomAccessFile comunidadFile = new RandomAccessFile("comunidades.text", "rwd");
	...
	public void almacenarEnFicheroLideresInvestigacion(LinkedList<LiderInvestigacion>lideres) throws IOException {
		RandomAccessFile lideresInvestFile = new RandomAccessFile("lideres.text", "rwd");
	...
	//Fichero con promedio
	public void almacenarPromedio(float promedio) throws IOException {
		RandomAccessFile promedioFile = new RandomAccessFile("promedio.text", "rwd");
		byte [] arrayLideres = Convert.toBytes(promedio);
