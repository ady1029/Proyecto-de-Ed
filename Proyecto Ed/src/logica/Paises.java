...
public enum Paises {
    ...
    ANTIGUA_Y_BARBUDA, ARGENTINA, ARMENIA, AUSTRALIA, AUSTRIA,
    AZERBAIJAN, BAHAMAS, BANGLADESH, BARBADOS, BELARUS,
    BELGIUM, BOLIVIA, BOSNIA_AND_HERZEGOVINA, BOTSWANA, BRAZIL,
    ...
    MOZAMBIQUE, NAMIBIA, NETHERLANDS, NEW_ZEALAND, NICARAGUA,
    NIGER, NIGERIA, NORTH_KOREA, NORWAY, OMAN,
    PAKISTAN, PALAU, PANAMA, PAPUA_NEW_GUINEA, PARAGUAY,
    PERU, POLAND, PORTUGAL, QATAR, ROMANIA,
    RUSSIA, RWANDA, SAINT_KITTS_AND_NEVIS, SAINT_LUCIA, SAINT_VINCENT_AND_THE_GRENADINES,
    SAMOA, SAN_MARINO, SÃO_TOM, SAUDI_ARABIA, SENEGAL,
    SERBIA, SEYCHELLES, SIERRA_LEONE, SINGAPORE, SLOVAKIA,
    SLOVENIA, SOMALIA, SOUTH_AFRICA, SOUTH_SUDAN, SPAIN,
    SRI_LANKA, SUDAN, SURINAME, SWEDEN, SWITZERLAND,
    SYRIA, TAIWAN, TAJIKISTAN, TANZANIA, THAILAND,
    TIMOR_LESTE, TOGO, TONGA, TRINIDAD_AND_TOBAGO, TUNISIA,
    TURKEY, TURKMENISTAN, TV, UKRAINE, UNITED_ARAB_EMIRATES,
    UNITED_KINGDOM, UNITED_STATES, URUGUAY, UZBEKISTAN, VANUATU,
    VATICAN_CITY, YEMEN, ZAMBIA, 
}
