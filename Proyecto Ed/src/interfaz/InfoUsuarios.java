...
public class InfoUsuarios extends JDialog {
	...
	public static void main(String[] args) {
		try {
			InfoUsuarios dialog = new InfoUsuarios();
	...
	public InfoUsuarios() {
		...
		avatarCircular.setAvatar(new ImageIcon(InfoUsuarios.class.getResource("/fotos/FotoUsuarios.png")));
