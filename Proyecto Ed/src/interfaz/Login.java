...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnRegistrarse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CrearCuenta dialog = new CrearCuenta(app, Login.this);
	...
	public static void inicializarDatos() {
		...
		sis.setAdministrador(new Person("admin", "1111", null, null));
		...
		sis.setGraph(grafo);
	    sis.crearSolicitud(((Person) sis.getGraph().getVerticesList().get(0).getInfo()),((Person) sis.getGraph().getVerticesList().get(1).getInfo()), 9);
		sis.crearSolicitud(((Person) sis.getGraph().getVerticesList().get(0).getInfo()),((Person) sis.getGraph().getVerticesList().get(2).getInfo()), 9);
		sis.crearSolicitud(((Person) sis.getGraph().getVerticesList().get(1).getInfo()),((Person) sis.getGraph().getVerticesList().get(2).getInfo()), 9);
	...
	private boolean accederAdm() {
		...
		char [] password= passwordField.getPassword();
		String clave= new String(password);
		String a = app.getAdministrador().getNick();
		String b= app.getAdministrador().getPassword();
